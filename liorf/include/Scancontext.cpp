...
std::pair<int, float> SCManager::detectLoopClosureID(void)
{
    ...
    if(min_dist < SC_DIST_THRES)
    {
        ...
        // polarcontexts_.size()-1 << " and " << nn_idx << "." << endl; cout << "[Loop found] yaw
        // diff: " << nn_align * PC_UNIT_SECTORANGLE << " deg." << endl;
    }
    else
    {
        std::cout.precision(3);
        // cout << "[Not loop] Nearest distance: " << min_dist << " btn " << polarcontexts_.size()-1
        // << " and " << nn_idx << "." << endl; cout << "[Not loop] yaw diff: " << nn_align *
        // PC_UNIT_SECTORANGLE << " deg." << endl;
    }
