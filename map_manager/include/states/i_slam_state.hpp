...
{
public:
    virtual ~ISLAMState() = default;

    virtual void GetSoftwareVersions(
        std::shared_ptr<interface_msgs::srv::Listing::Response> response)                     = 0;
    virtual void AddFloor(const std::shared_ptr<interface_msgs::srv::SetString::Request> request,
                          std::shared_ptr<interface_msgs::srv::SetString::Response> response) = 0;
    virtual void ClearMap(std::shared_ptr<std_srvs::srv::Trigger::Response> response)         = 0;
    virtual void ClearFloor(std::shared_ptr<std_srvs::srv::Trigger::Response> response)       = 0;
    virtual void ClearPath(std::shared_ptr<std_srvs::srv::Trigger::Response> response)        = 0;
    virtual void DeleteFloor(
        const std::shared_ptr<interface_msgs::srv::ActionOnIndex::Request> request,
        std::shared_ptr<interface_msgs::srv::ActionOnIndex::Response>      response)              = 0;
    virtual void GetFloors(std::shared_ptr<interface_msgs::srv::Listing::Response> response) = 0;
    virtual void GetViewFloor(
        std::shared_ptr<interface_msgs::srv::GetIndex::Response> response) = 0;
    virtual void SelectViewFloor(
        const std::shared_ptr<interface_msgs::srv::ActionOnIndex::Request> request,
        std::shared_ptr<interface_msgs::srv::ActionOnIndex::Response>      response) = 0;
    virtual void GetLocalizationFloor(
        const std::shared_ptr<interface_msgs::srv::GetIndex::Request> request,
        std::shared_ptr<interface_msgs::srv::GetIndex::Response>      response) = 0;
    virtual void SelectLocalizationFloor(
        const std::shared_ptr<interface_msgs::srv::ActionOnIndex::Request> request,
        std::shared_ptr<interface_msgs::srv::ActionOnIndex::Response>      response) = 0;
    virtual void SetFloorName(
        const std::shared_ptr<interface_msgs::srv::UpdateStringAt::Request> request,
        std::shared_ptr<interface_msgs::srv::UpdateStringAt::Response>      response) = 0;
    ...
    virtual std::optional<std::string>           GetViewFloorName()                         = 0;
    ...
    virtual std::string GetFloorName(int index)                                             = 0;
